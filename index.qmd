...
cor(select(df, CreditScore, Age, Tenure, Balance, NumOfProducts, EstimatedSalary))
```
...
```{r}
# Scatter plot of Age vs EstimatedSalary colored by Exited
...
7.  Deris, A. M., Zain, A. M., & Sallehuddin, R. (2011). Overview of
    support vector machine in modeling machining performances. *Procedia
    Engineering*, *24*, 308-312.

8.  Han, Shuo. “Using SVM with Financial Statement Analysis for
...
9.  Ahmadi, Muhammad Iqbal, et al. “SENTIMENT ANALYSIS ONLINE SHOP on
...
10. Razzaghi, Talayeh, et al. “Multilevel Weighted Support Vector
...
11. Öz, Ersoy, and Hüseyin Kaya. “Support Vector Machines for Quality
...
15. Nawal, Y., Oussalah, M., Fergani, B., & Fleury, A. (2022). New
...
16. Zhang, L., Hu, H., & Zhang, D. (2015). A credit risk assessment
...
17. Harimoorthy, K., Thangavelu, M. RETRACTED ARTICLE: Multi-disease
...
18. J. Liang, Z. Qin, L. Xue, X. Lin and X. Shen, "Verifiable and Secure
...
19. G. N. Ahmad, H. Fatima, S. Ullah, A. Salah Saidi and Imdadullah,
...
20. Sahara, S., Annida Purnamawati, Sulaeman Hadi Sukmana, Mely
...
21. “Prediction of Consumer Purchasing in a Grocery Store Using Machine
    Learning Techniques.” *Ieeexplore.ieee.org*,
    ieeexplore.ieee.org/document/7941935.

22. Barakat, Nahla, et al. “Intelligible Support Vector Machines for
...
23. “Applying Support Vector Machine to Electronic Health Records for
...
24. “An Effective Intrusion Detection Approach Using SVM with Naïve
...
25. Hosseini, Soodeh, and Behnam Mohammad Hasani Zade. “New Hybrid
